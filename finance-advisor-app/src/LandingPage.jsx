    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-100">
      ...
      <nav className="border-b bg-white/80 backdrop-blur sticky top-0 z-50">
        <div className="container mx-auto px-4 flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <a href="#" className="text-gray-700 hover:text-teal-600" onClick={e => { e.preventDefault(); navigate('/login'); }}>Login</a>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            ...
            <a href="#" className="block px-4 py-2 text-gray-700" onClick={e => { e.preventDefault(); setIsMenuOpen(false); navigate('/login'); }}>Login</a>
          </div>
        )}
      </nav>
      ...
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-teal-400 to-blue-500 text-white text-center">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 animate-fade-in">
            ...
            <Button size="lg" className="bg-white text-teal-700 font-bold shadow-lg" onClick={() => navigate('/login')}>Get Started</Button>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-teal-400 to-blue-500 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Button size="lg" className="bg-white text-teal-700 font-bold shadow-lg text-lg px-8 py-6" onClick={() => navigate('/signup')}>
